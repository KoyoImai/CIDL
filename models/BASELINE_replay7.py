...
class BASELINE_replay7(BaseLearner):
    ...
    def _train_function(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                # ⑤ 損失を計算
                # ----------------------------------------
                logits, loss_new, loss_fkd, loss_proto, loss_unl = self._compute_loss(inputs, targets, aug_targets)
    ...
    def _compute_loss(self, inputs, targets, aug_targets):
        ...
        if forget_mask.any():
            ...
            loss_unl = lambda_unl * torch.nn.functional.kl_div(
